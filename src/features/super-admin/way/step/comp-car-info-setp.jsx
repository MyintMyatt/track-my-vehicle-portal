...
import { AppFormDropDown, AppFormInput, AppFormInputRow } from "../../../../components/comp-form-input";
        ...
        <div className="space-y-6">
            {
                fields.map((item, index) => (
                    <div key={item.id} className="p-5 flex flex-col gap-5 border rounded-2xl border-slate-200">
